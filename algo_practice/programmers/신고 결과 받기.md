...
public class 신고_결과_받기 {
    ...
    public static int[] solution (String[] pple, String[] reports, int report) {
        int[] answer = new int[pple.length];
        Map<String, Set<String>> reportedCase = new HashMap<>();
        ...
        for (int i = 0; i < pple.length; i++) {
            answer[i] = reportedCase.getOrDefault(pple[i], new HashSet<>()).size();
